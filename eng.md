...
Now, let’s add some CSS in the head that will set up the “space” background
...
But I digress. Moving on… Let’s look at the last thing that’s going on in the 
`init()` function:
...
Thanks to [MillionthVector for the sprites][20]

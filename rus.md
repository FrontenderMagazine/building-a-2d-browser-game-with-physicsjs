...
на *абсолютно другой*. При наличии большого желания вы даже можете создать 
свой собственный способ визуализации. В скором времени мы планируем добавить 
в нашу документацию описание [методики, руководствуясь которой вы сможете 
это сделать][11].
...
методы симуляции маневрирования кораблем. Лучшим планом действий для нас будет 
применение одной из моих любимых возможностей в PhysicsJS, *возможности 
неограниченного расширения практически всего на свете*. В данном случае, 
мы будем работать над расширением объектов, с которыми мы взаимодействуем в 
мире игры. 
...
сферическая форма ([ха-ха][16]), дополним тело `circle` так, как [описано в 

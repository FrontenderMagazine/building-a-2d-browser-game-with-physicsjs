...
1. Это способ визуализации, можно легко расширить или даже, вовсе, заменить на 
*абсолютно другой*. При наличии большого желания вы даже можете создать свой 
собственный способ визуализации. В скором времени мы планируем добавить в нашу 
документацию описание [методики, руководствуясь которой вы сможете это сделать][11].

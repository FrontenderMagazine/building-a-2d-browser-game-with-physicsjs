...
1. Это способ визуализации, можно легко расширить или даже, вовсе, заменить *абсолютно другой*. При наличии большого желания вы даже можете создать свой собственный способ визуализации. В скором времени мы планируем добавить в нашу документацию описание [методики, руководствуясь которой вы сможете это сделать][11].
...
бы сделать с нашим кораблём нечто похожее на то, что сделали с планетой, однако, нам не достаточно только применения подходящего внешнего облика. Нам нужны методы симуляции маневрирования кораблем. Лучшим планом действий для нас будет применение одной из моих любимых возможностей в PhysicsJS, *возможности  неограниченного расширения практически всего на свете*. В данном случае, мы будет работать над расширением объектов, с которыми мы взаимодействуем в мире игры. 
